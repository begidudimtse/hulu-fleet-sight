const HQ = { lat: 9.0108, lng: 38.7613 };
const equipment = [
  ...
  { id: "EQ-1048", name: "Hitachi ZX350 Excavator", type: "Excavator", serial: "HIT-ZX350-12", operator: "Tigist B.", status: "active", battery: 78, speed: 9, lat: 9.009, lng: 38.798, site: "Megenagna Road Works", lastUpdate: "8s ago" },
  { id: "EQ-1049", name: "JCB 3CX Loader", type: "Loader", serial: "JCB-3CX-451", operator: "Kalkidan M.", status: "idle", battery: 88, speed: 0, lat: 9.0156, lng: 38.735, site: "Kality Logistics Hub", lastUpdate: "3m ago" }
];
const geofences = [
  { id: "GF-01", name: "Bole Tower Site Perimeter", site: "Bole Tower Project", lat: 9.02, lng: 38.77, radius: 800, active: true, assigned: 3 },
  { id: "GF-02", name: "Megenagna Road Zone", site: "Megenagna Road Works", lat: 8.997, lng: 38.792, radius: 1200, active: true, assigned: 2 },
  { id: "GF-03", name: "Kality Logistics Hub", site: "Kality Logistics Hub", lat: 9.028, lng: 38.748, radius: 600, active: true, assigned: 2 },
  { id: "GF-04", name: "Akaki Quarry Boundary", site: "Akaki Quarry", lat: 8.995, lng: 38.742, radius: 500, active: true, assigned: 1 },
  { id: "GF-05", name: "CMC Expansion Area", site: "CMC Expansion", lat: 9.047, lng: 38.77, radius: 900, active: false, assigned: 1 }
];
const alerts = [
...
const gpsLogs = Array.from({ length: 24 }).map((_, i) => {
